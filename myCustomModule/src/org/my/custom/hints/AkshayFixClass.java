...
@Hint(displayName = "#DN_AkshayFixClass", description = "#DESC_AkshayFixClass", category = "general")
@Messages({
    "DN_AkshayFixClass=akshayHint",
    "DESC_AkshayFixClass=Remove showMessage statement"
})
public class AkshayFixClass {
    ...
    @Messages("ERR_AkshayFixClass=akshay hinting remove this statment")
    public static ErrorDescription computeWarning(HintContext ctx) {
        Fix fix = new FixImpl(ctx.getInfo(), ctx.getPath()).toEditorFix();
        return ErrorDescriptionFactory.forName(ctx, ctx.getPath(), Bundle.ERR_AkshayFixClass(),fix);
    }
